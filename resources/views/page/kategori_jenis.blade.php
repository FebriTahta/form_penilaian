            ...
            <div class="container-fluid text-white">
                <div class="row p-t-b-10 ">
                    <div class="col">
                        <h4>
                            <i class="icon-box"></i>
                            Forms Kategori Penilaian " {{$jenis->nama_jenis}} "
                        </h4>
                        <input type="hidden" id="s_jenis" value="{{$jenis->slug_jenis}}">
                    </div>
                </div>
                <div class="row">
                        ...
                        <div class="col-md-3">
                            <div class="counter-box white r-5 p-3">
                                <div class="p-4">
                                    ...
                                    <h5 class="sc-counter mt-3" id="total_kategori">{{$kategori}}</h5>
                                </div>
            ...
            <div class="modal-content b-0">
                ...
                <form id="formadd" method="POST" enctype="multipart/form-data">@csrf
                    <div class="modal-body">
                        ...
                        <div class="form-group">
                            <input type="hidden" class="form-control" id="jenis_id" name="jenis_id" value="{{$jenis->id}}" required>  
                        </div>
                        <div class="form-group">
    ...
    <script>
        ...
        $(document).ready(function() {
            ...
            $('#table-data').DataTable({
                ...
                serverSide: true,
                ajax: {
                    url: '/kategori-form-penilaian/' + s_jenis,
                },
                columns: [
                    {
                        "width": 10,
